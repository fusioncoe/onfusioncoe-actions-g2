// ensure-business-application-platform - Test Script
...
const event_path = path.resolve(`${__dirname}\\..\\.testinput\\ensure-business-application-platform.json`);
...
const test = async () => {
    ...
    core.info("currently running ensure-business-application-platform test");
