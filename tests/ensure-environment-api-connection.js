// ensure-environment-api-connection - Test Script
...
const event_path = path.resolve(`${__dirname}\\..\\.testinput\\ensure-environment-api-connection.json`);
...
const test = async () => {
    ...
    core.info("currently running ensure-environment-api-connection test");
